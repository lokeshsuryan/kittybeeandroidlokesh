package com.kittyapplication.chat.custom;
...
public class CircluarProgressBarWithNumber extends
		HorizontalProgressBarWithNumber
{
	...
	public CircluarProgressBarWithNumber(Context context)
	{
		this(context, null);
	}

	public CircluarProgressBarWithNumber(Context context, AttributeSet attrs)
	{
		super(context, attrs);

		mReachedProgressBarHeight = (int) (mUnReachedProgressBarHeight * 2.5f);
		TypedArray ta = context.obtainStyledAttributes(attrs,
				R.styleable.CircluarProgressBarWithNumber);
		mRadius = (int) ta.getDimension(
				R.styleable.CircluarProgressBarWithNumber_radius, mRadius);
		ta.recycle();
