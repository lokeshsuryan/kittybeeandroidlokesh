 ...
 */
public class ChatActivityTemp extends ChatBaseActivity implements OnImagePickedListener,
        OnFileUploadListener, QBChatDialogMessageSentListener, QBMessageStatusListener {

    private static final String TAG = ChatActivityTemp.class.getSimpleName();
    ...
    public static void startForResult(Activity activity, int code,
        ...
        try {
            Intent intent = new Intent(activity, ChatActivityTemp.class);
                ...
                new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog qbDialog, Bundle bundle) {
                        try {
                            ...
                            ChatActivityTemp.this.qbDialog = qbDialog;
//                            addChatListener();
                            initDialogForChat();
...
//            qbDialog.addMessageListener(chatMessageListener);
    ...
    private void bindView(ArrayList<QBMessage> messages) {
        chatAdapter = new ChatMessageAdapter(ChatActivityTemp.this, messages);
                ...
                public Bitmap performInBackground(Void... params) throws Exception {
                    try {
                        ...
                        if (user.getPhone() != null && user.getPhone().length() > 0) {
                            user.setFullName(Utils.getDisplayNameByPhoneNumber(ChatActivityTemp.this, user.getPhone()));
                        }
...
//            showMessage(qbChatMessage);
    ...
    private void initChatMessageListener() {
        try {
            ...
            manager.addMessageStatusListener(ChatActivityTemp.this);
            qbDialog.addMessageSentListener(ChatActivityTemp.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
