...
public class PartnersDetailsActivity extends BaseActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(PartnersDetailsActivity.this).inflate(
                R.layout.activity_partners_details_activity, null);
