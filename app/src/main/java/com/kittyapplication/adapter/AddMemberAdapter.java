 ...
 */
public class AddMemberAdapter extends BaseAdapter implements Filterable {
    private static final String TAG = AddMemberAdapter.class.getSimpleName();
    ...
    public AddMemberAdapter(Context context, List<ContactDao> lists) {
        mList = lists;
        mListClone = lists;
        mContext = context;
...
//        }
//
//        if (mList.get(position).getPhone().equalsIgnoreCase(PreferanceUtils.getLoginUserObject(mContext).getPhone())) {
//            viewHolder.mTxtUserName.setText(mContext.getResources().getString(R.string.you));
//        }
