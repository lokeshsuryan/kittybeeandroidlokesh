 ...
 */
public class StaggredGridView extends ScrollView {
    ...
    public StaggredGridView(Context context) {
        super(context);
    ...
    @SuppressLint("NewApi")
    public StaggredGridView(Context context, AttributeSet attrs,
...
//                }
    ...
    private LinearLayout getRow() {
        final LinearLayout lRow = (LinearLayout) LayoutInflater.from(getContext()).inflate(
                R.layout.row_layout_spannable, null);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
